...
def gauge_chart(main_filter, dataset, region, data_time):
    ...
    fig_gaug = go.Figure(go.Indicator(
        ...
        mode='gauge+number',
        title={'text': region, 'font': {'size': 13, 'family': 'Arial Black'}},
            ...
            dbc.Container([
                dbc.Row([
                    ...
                    dbc.Col(html.H3('For a deeper understanding of the video game industry and the factors that contribute to the success of video games sales', className='text-left d-flex align-items-center',
                        style={'font-family': 'Arial', 'font-size': '14px', 'color': '#006276'}),
                        width={'size': 7}),],
                        className='mt-1 d-flex align-items-center', style={'background-color': '#95b9e8', 'height': '60px', 'border-radius': '2px'}),
                dbc.Row([
                    ...
                    ], className='mt-2 d-flex align-items-center', style={'background-color': '#bad4f5', 'height': '50px', 'border-radius': '8px'}
                ),
                dbc.Row(
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Row(html.H5('Sales Ranking',
                                    className='text-left d-flex align-items-center', style={'background-color': '#bad4f5', 'font-weight': 'bold', 'border-radius': '8px', 'height': '40px', 'weight': 'bold', 'color': '#006276'})),
                    ...
                    dbc.Col([
                        dbc.Row(dcc.Graph(id='stable_diagram', figure={}),
                             style={'height': '295px', 'margin-top': '0px', 'box-shadow': '2px 1px 4px rgba(0, 0, 0, 0.1)'}),
                        ...
                        style={'margin-left': '150px', 'height': '28px', 'width': '68%', 'background-color': '#bad4f5', 'border-radius': '8px', 'box-shadow': '0px 0px 4px rgba(0, 0, 0, 0.2)'},
                        ),
                        html.Div(style={'height': '7px'}),
                        dbc.Row(dcc.Graph(id='line_diagram', figure={}),
                                style={'height': '295px', 'box-shadow': '2px 1px 4px rgba(0, 0, 0, 0.1)'
                    }
                                ),
                        ],
                        width={'size':7},
                    ...
                    dbc.Col([
                        dbc.Row(html.H5('Market Share by Region',
                                    className='text-left d-flex align-items-center', style={'background-color': '#bad4f5', 'font-weight': 'bold', 'border-radius': '8px', 'height': '40px', 'color': '#006276'})),
                        dbc.Row(html.H6(id='share_global',
                                        style={'text-align': 'center', 'marigin-top': '5px', 'margin-bottom': '10px', 'font-size': '12px'}
                                        )),
